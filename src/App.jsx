...
<nav className="p-4 border-b flex justify-between items-center sticky top-0 bg-white/80 backdrop-blur-md z-40 px-6">
  <div className="flex items-center gap-2">
    {/* Agregamos un "versionamiento" (?v=1) para obligar al navegador a ignorar el logo viejo guardado en caché */}
    <img src="/logo.png?v=1" className="w-10 h-10 rounded-full object-cover shadow-sm" alt="Logo" />
  ...
  <button onClick={() => setAbierto(true)} className="relative p-2 text-black hover:bg-gray-100 rounded-full transition-colors">
