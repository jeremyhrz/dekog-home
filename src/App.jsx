...
const productos = [
  { id: 1, nombre: 'Dubai', precio: 1450, categoria: 'Sofás', imagen: '/muebles/dubai.jpg', desc: 'Medida 2.70M' },
  { id: 2, nombre: 'Abu Dabi', precio: 1290, categoria: 'Sofás', imagen: '/muebles/abudabi.jpg', desc: 'Medida 2.40M' },
  { id: 3, nombre: 'Qatar', precio: 1655, categoria: 'Sofás', imagen: '/muebles/qatar.jpg', desc: '2.35M + Puff y Cojines' },
  { id: 4, nombre: 'Doha', precio: 1885, categoria: 'Sofás', imagen: '/muebles/doha.jpg', desc: 'Medida 2.70M' },
  { id: 5, nombre: 'Israel', precio: 1200, categoria: 'Sofás', imagen: '/muebles/israel.jpg', desc: 'Diseño Arquitectónico' },
  { id: 6, nombre: 'Estambul', precio: 1170, categoria: 'Sofás', imagen: '/muebles/estambul.jpg', desc: 'Elegancia Clásica' },
  { id: 7, nombre: 'Vancouver', precio: 1290, categoria: 'Sofás', imagen: '/muebles/vancouver.jpg', desc: 'Estilo Vanguardista' },
  { id: 8, nombre: 'Seul', precio: 1095, categoria: 'Sofás', imagen: '/muebles/seul.jpg', desc: 'Minimalismo Puro' },
  { id: 9, nombre: 'Amsterdam', precio: 1215, categoria: 'Sofás', imagen: '/muebles/amsterdam.jpg', desc: 'Confort Premium' },
  { id: 10, nombre: 'Londres', precio: 985, categoria: 'Sofás', imagen: '/muebles/londres.jpg', desc: 'Diseño Urbano' },
  { id: 11, nombre: 'Texas', precio: 1255, categoria: 'Sofás', imagen: '/muebles/texas.jpg', desc: 'Robusto y Elegante' },
  { id: 12, nombre: 'Seattle', precio: 985, categoria: 'Sofás', imagen: '/muebles/seattle.jpg', desc: 'Moderno' },
  { id: 13, nombre: 'Praga', precio: 985, categoria: 'Sofás', imagen: '/muebles/praga.jpg', desc: 'Líneas Finas' },
  { id: 14, nombre: 'Atenas', precio: 960, categoria: 'Sofás', imagen: '/muebles/atenas.jpg', desc: 'Equilibrio y Confort' },
  { id: 15, nombre: 'Edimburgo', precio: 1020, categoria: 'Sofás', imagen: '/muebles/edimburgo.jpg', desc: 'Clásico Renovado' },
  { id: 16, nombre: 'Eslovaquia', precio: 985, categoria: 'Sofás', imagen: '/muebles/eslovaquia.jpg', desc: 'Diseño Único' },
  { id: 17, nombre: 'Cama Tokio', precio: 405, categoria: 'Camas', imagen: '/muebles/tokio.jpg', desc: 'Base Lisa Individual' },
  { id: 18, nombre: 'Cama Toronto', precio: 405, categoria: 'Camas', imagen: '/muebles/toronto.jpg', desc: 'Base Lisa Individual' },
  { id: 19, nombre: 'Cama Manila', precio: 405, categoria: 'Camas', imagen: '/muebles/manila.jpg', desc: 'Base Lisa Individual' },
  { id: 20, nombre: 'Cama Houston', precio: 480, categoria: 'Camas', imagen: '/muebles/houston.jpg', desc: 'Base Lisa Individual' },
  { id: 21, nombre: 'Cama Italia', precio: 480, categoria: 'Camas', imagen: '/muebles/italia.jpg', desc: 'Base Lisa Individual' },
  { id: 22, nombre: 'Cama Milan', precio: 445, categoria: 'Camas', imagen: '/muebles/milan.jpg', desc: 'Base Lisa Individual' },
  { id: 23, nombre: 'Cama Venecia', precio: 480, categoria: 'Camas', imagen: '/muebles/venecia.jpg', desc: 'Base Lisa Individual' },
  { id: 24, nombre: 'Cama Georgia', precio: 480, categoria: 'Camas', imagen: '/muebles/georgia.jpg', desc: 'Base Lisa Individual' },
  { id: 25, nombre: 'Puff COD-2001', precio: 370, categoria: 'Puffs', imagen: '/muebles/2001.jpg', desc: 'Circular' },
  { id: 26, nombre: 'Puff COD-2000', precio: 480, categoria: 'Puffs', imagen: '/muebles/2000.jpg', desc: 'Capitoneado Cuadrado' },
  { id: 27, nombre: 'Puff COD-2003', precio: 280, categoria: 'Puffs', imagen: '/muebles/2003.jpg', desc: 'Minimalista' },
  { id: 28, nombre: 'Puff COD-2002', precio: 280, categoria: 'Puffs', imagen: '/muebles/2002.jpg', desc: 'Versátil' },
  { id: 29, nombre: 'Puff COD-2005', precio: 480, categoria: 'Puffs', imagen: '/muebles/2005.jpg', desc: 'Premium' },
  { id: 30, nombre: 'Puff COD-2004', precio: 480, categoria: 'Puffs', imagen: '/muebles/2004.jpg', desc: 'Gran Formato' },
];
      ...
      <nav className="p-4 border-b flex justify-between items-center sticky top-0 bg-white/80 backdrop-blur-md z-40 px-6">
        <div className="flex items-center gap-2">
           ...
           <div className="flex flex-col">
             <span className="font-black text-xl tracking-tighter uppercase">Dekog Home</span>
             <span className="text-[8px] uppercase tracking-[0.2em] text-gray-400">Diseño y Confort</span>
           </div>
        </div>
        <button onClick={() => setAbierto(true)} className="relative p-2">
          <ShoppingCart size={24} />
          {carrito.length > 0 && <span className="absolute top-0 right-0 bg-black text-white text-[10px] w-5 h-5 rounded-full flex items-center justify-center font-bold">{carrito.length}</span>}
        </button>
      </nav>
